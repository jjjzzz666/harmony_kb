...
**注意：**  
​	    1、获取蜂窝流量接口（getCellularRxBytes、getCellularTxBytes）需要设备插入SIM卡，且蜂窝连接状态下使用。

​	    2、指定应用相关接口（getUidRxBytes、getUidTxBytes）需要指定已有流量消耗的应用。
