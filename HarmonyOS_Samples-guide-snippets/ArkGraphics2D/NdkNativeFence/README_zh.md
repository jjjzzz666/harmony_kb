...
2. **SDK 版本**：本示例已适配 API Version 20 版本 SDK，适用于 SDK 版本号（API Version 20 Release）、镜像版本号（6.0.0 Release）。

3. **开发工具**：本示例需要使用 DevEco Studio 版本号（6.0.0 Release）及以上版本进行编译和运行。
...
echo ArkGraphics2D/NdkNativeFence > .git/info/sparse-checkout
