...
1. 色彩空间转换相关接口调用换封装在PluginManager中，源码参考[PluginManager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/MediaKit/VideoProcessing/entry/src/main/cpp/render/PluginManager.cpp)。
2. 视频动态元数据生成相关接口调用换封装在PluginManager中，源码参考[PluginManager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/MediaKit/VideoProcessing/entry/src/main/cpp/render/PluginManager.cpp)。
