...
// 创建Swiper子节点，添加11个Text子组件显示数字0-10
...
// 处理onChange事件：当前显示的子组件索引发生变化时触发
...
// 处理onContentDidScroll事件：内容滚动时触发
...
// 处理onContentWillScroll事件：内容即将滚动时触发
...
// 处理onScrollStateChanged事件：滚动状态变化时触发
