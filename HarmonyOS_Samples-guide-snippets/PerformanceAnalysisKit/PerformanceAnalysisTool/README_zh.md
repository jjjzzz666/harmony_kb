...
- [使用jsLeakWatcher检测对象泄露（ArkTS/JS）](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-jsleakwatcher#jsleakwatcherenable)

###  效果预览

|                             主页                             |
| :----------------------------------------------------------: |
| <img src="./screenshots/image2.png" alt="z" width = "400"> |
...
##### 7.jsLeakWatcher（ArkTS/JS）使用说明

1.在主界面，点击Enable JsLeakWatcher按钮；
切换到"Log"窗口，日志过滤选择"No filters",搜索内容设置为"testTag"。成功输出如下数据即为成功：

```
testJsLeakWatcher leakListFileName: /data/storage/el2/base/haps/entry/files/1762487122462.jsleaklist
```
2.检测结束后，在主界面，点击Disable JsLeakWatcher按钮。
