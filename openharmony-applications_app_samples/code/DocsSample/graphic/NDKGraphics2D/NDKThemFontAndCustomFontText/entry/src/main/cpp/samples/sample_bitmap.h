...
public:
    ...
    static napi_value NapiDrawCustomFontText(napi_env env, napi_callback_info info);
    static napi_value NapiPrintSysFontMetrics(napi_env env, napi_callback_info info);
    static napi_value NapiDrawDisableSysFontText(napi_env env, napi_callback_info info);
    static void Release(std::string &id);
    void DrawText();
    void DrawCustomFontText();
    void PrintSysFontMetrics();
    void DrawDisableSysFontText();
