...
public:
    ...
    static napi_value NapiDrawMultilingualText(napi_env env, napi_callback_info info);
    static napi_value NapiDrawMultilineText(napi_env env, napi_callback_info info);
    static napi_value NapiAddFontFeature(napi_env env, napi_callback_info info);
    static void Release(std::string &id);
    void DrawMultilingualText();
