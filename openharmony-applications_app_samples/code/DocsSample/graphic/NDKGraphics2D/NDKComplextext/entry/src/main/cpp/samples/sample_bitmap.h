...
public:
    ...
    static napi_value NapiAddFontVariation(napi_env env, napi_callback_info info);
    static napi_value NapiSetTextShadow(napi_env env, napi_callback_info info);
    static napi_value NapiSetTextBrush(napi_env env, napi_callback_info info);
    static napi_value NapiSetTextEllipsis(napi_env env, napi_callback_info info);
    static void Release(std::string &id);
    void AddFontVariation();
    void SetTextShadow();
    void SetTextBrush();
    void SetTextEllipsis();
