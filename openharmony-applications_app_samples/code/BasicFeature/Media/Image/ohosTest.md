...
| 验证图片删除功能                      | 点击图片进入照片编辑删除页面 | 点击删除按钮                               | 回到首页，首页该图片取消                                   | 是  | Pass |
| 验证评论功能                        | 进入应用主页 | 在评论输入框填写评价                           | 评价内容正常显示                                       | 是 | Pass |
| 验证JPEG多图解码(js)                | 进入应用主页 | 点击多图操作-js接口-解码-JPEG                  | Sourcegraph显示原图片 <br/>Resultgraph显示JPEG解码后的辅助图 | 是 | Pass |
| 验证HEIF多图解码(js)                | 进入应用主页 | 点击多图操作-js接口-解码-HEIF                  | Sourcegraph显示原图片 <br/>Resultgraph显示HEIF解码后的辅助图 | 是 | Pass |
| 验证JPEG多图解码(native)               | 进入应用主页 | 点击多图操作-native接口-解码-JPEG              | Sourcegraph显示原图片 <br/>Resultgraph显示JPEG解码后的辅助图 | 是 | Pass |
| 验证HEIF多图解码(native)               | 进入应用主页 | 点击多图操作-native接口-解码-HEIF                 | Sourcegraph显示原图片 <br/>Resultgraph显示HEIF解码后的辅助图 | 是 | Pass |
| 验证imagesouce编码成buffer(js)     | 进入应用主页 | 点击多图操作-js接口-编码-sourceToFile          | Sourcegraph显示原图片 <br/>Resultgraph显示编码后的多图      | 是 | Pass |
| 验证imagesouce编码成file(js)       | 进入应用主页 | 点击多图操作-js接口-编码-sourceToBuffer        | Sourcegraph显示原图片 <br/>Resultgraph显示编码后的多图    | 是 | Pass |
| 验证多图对象编码成buffer(js)           | 进入应用主页 | 点击多图操作-js接口-编码-pictureToFile         | Sourcegraph显示原图片 <br/>Resultgraph显示编码后的多图    | 是 | Pass |
| 验证多图对象编码成file(js)             | 进入应用主页 | 点击多图操作-js接口-编码-pictureToBuffer       | Sourcegraph显示原图片 <br/>Resultgraph显示编码后的多图    | 是 | Pass |
| 验证imagesouce编码成buffer(native) | 进入应用主页 | 点击多图操作-native接口-编码-sourceToFile         | Sourcegraph显示原图片 <br/>Resultgraph显示编码后的多图      | 是 | Pass |
| 验证imagesouce编码成file(native)      | 进入应用主页 | 点击多图操作-native接口-编码-sourceToBuffer       | Sourcegraph显示原图片 <br/>Resultgraph显示编码后的多图    | 是 | Pass |
| 验证多图对象编码成buffer(native)          | 进入应用主页 | 点击多图操作-native接口-编码-pictureToFile        | Sourcegraph显示原图片 <br/>Resultgraph显示编码后的多图    | 是 | Pass |
| 验证多图对象编码成file(native)            | 进入应用主页 | 点击多图操作-native接口-编码-pictureToBuffer      | Sourcegraph显示原图片 <br/>Resultgraph显示编码后的多图    | 是 | Pass |